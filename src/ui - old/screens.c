...
void create_screen_main() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        {
            // Tabs
            lv_obj_t *obj = lv_tabview_create(parent_obj, LV_DIR_TOP, 25);
            objects.tabs = obj;
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, 480, 240);
                        ...
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xffb7b7b7), LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    ...
                                    // lv_img_set_src(obj, &img_cooking);
                                ...
                                }
                                {
                                    ...
                                    lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_team, LV_EVENT_PRESSED, (void *)1);
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_team, LV_EVENT_PRESSED, (void *)2);
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_team, LV_EVENT_PRESSED, (void *)0);
                                ...
                                }
                                {
                                    ...
                                    lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_side, LV_EVENT_PRESSED, (void *)0);
                                            lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                                            lv_obj_set_style_transform_height(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            lv_obj_set_style_transform_width(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 18, 49);
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_side, LV_EVENT_PRESSED, (void *)1);
                                            lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                                            lv_obj_set_style_transform_height(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            lv_obj_set_style_transform_width(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            {
                                ...
                                }
                                {
                                    ...
                                    lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 18, 21);
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_auto_type, LV_EVENT_PRESSED, (void *)0);
                                            lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                                            lv_obj_set_style_transform_height(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            lv_obj_set_style_transform_width(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 18, 41);
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_auto_type, LV_EVENT_PRESSED, (void *)1);
                                            lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                                            lv_obj_set_style_transform_height(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            lv_obj_set_style_transform_width(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_set_pos(obj, 18, 61);
                                            lv_obj_set_size(obj, 186, 16);
                                            lv_obj_add_event_cb(obj, action_update_auto_type, LV_EVENT_PRESSED, (void *)2);
                                            lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                                            lv_obj_set_style_transform_height(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            lv_obj_set_style_transform_width(obj, -1, LV_PART_MAIN | LV_STATE_PRESSED);
                                            {
                                ...
                                }
                                {
                                    ...
                                    lv_obj_set_pos(obj, 8, 172);
                                    lv_obj_set_size(obj, 441, 20);
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff00ff2e), LV_PART_ITEMS | LV_STATE_CHECKED);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_pos(obj, 291, 40);
                    lv_obj_set_size(obj, 164, 136);
